...
針對經銷商，了解消費者喜好與購買記錄是一個競爭優勢。 經銷商已使用此類資料數年，並結合機器學習以指出與消費者相關的產品並提供個人化的購物體驗。 此方式稱為**產品建議**，而且它會為經銷商產生大幅的營收串流。 建議系統有助於回答如下問題：這個人下次將看哪一部電影？此客戶可能對哪些額外服務感興趣？此客戶想要到哪裡度假？
